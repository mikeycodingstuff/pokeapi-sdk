...
beforeEach(function (): void {
    $this->endpoint = ResourceEndpoints::MOVE_BATTLE_STYLE;
    ...
    $this->singleRequestClass = GetSingleMoveBattleStyle::class;
    $this->allRequestClass = GetAllMoveBattleStyles::class;
...
describe('Get a single Move BattleStyle', function (): void {
    it('sends a request with an id (int) and receives the expected response', function (): void {
        $response = $this->connector->moveBattleStyle()->get(1);
    ...
    it('sends a request with a name (string) and receives the expected response', function (): void {
        ...
        $response = $this->connector->moveBattleStyle()->get('attack');
...
describe('Get all Move BattleStyles', function (): void {
    it('sends a request and receives the expected response', function (): void {
        $response = $this->connector->moveBattleStyle()->all();
