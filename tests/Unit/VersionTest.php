...
beforeEach(function (): void {
    $this->endpoint = ResourceEndpoints::VERSION;
    ...
    $this->singleRequestClass = GetSingleVersion::class;
    $this->allRequestClass = GetAllVersions::class;
...
describe('Get a single Version', function (): void {
    ...
    it('sends a request with a name (string) and receives the expected response', function (): void {
        ...
        $response = $this->connector->version()->get('red');
...
describe('Get all Versions', function (): void {
    it('sends a request and receives the expected response', function (): void {
        $response = $this->connector->version()->all();
