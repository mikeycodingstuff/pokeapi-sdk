...
beforeEach(function (): void {
    $this->endpoint = ResourceEndpoints::MACHINE;
    ...
    $this->singleRequestClass = GetSingleMachine::class;
    $this->allRequestClass = GetAllMachines::class;
