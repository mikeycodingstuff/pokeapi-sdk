...
beforeEach(function (): void {
    $this->endpoint = ResourceEndpoints::POKEATHLON_STAT;
    ...
    $this->singleRequestClass = GetSinglePokeathlonStat::class;
    $this->allRequestClass = GetAllPokeathlonStats::class;
...
describe('Get a single Pokeathlon Stat', function (): void {
    it('sends a request with an id (int) and receives the expected response', function (): void {
        $response = $this->connector->pokeathlonStat()->get(1);
    ...
    it('sends a request with a name (string) and receives the expected response', function (): void {
        ...
        $response = $this->connector->pokeathlonStat()->get('speed');
...
describe('Get all Pokeathlon Stats', function (): void {
    it('sends a request and receives the expected response', function (): void {
        $response = $this->connector->pokeathlonStat()->all();
