...
beforeEach(function (): void {
    $this->endpoint = ResourceEndpoints::MOVE_AILMENT;
    ...
    $this->singleRequestClass = GetSingleMoveAilment::class;
    $this->allRequestClass = GetAllMoveAilments::class;
...
describe('Get a single Move Ailment', function (): void {
    it('sends a request with an id (int) and receives the expected response', function (): void {
        $response = $this->connector->moveAilment()->get(1);
    ...
    it('sends a request with a name (string) and receives the expected response', function (): void {
        ...
        $response = $this->connector->moveAilment()->get('paralysis');
...
describe('Get all Move Ailments', function (): void {
    it('sends a request and receives the expected response', function (): void {
        $response = $this->connector->moveAilment()->all();
