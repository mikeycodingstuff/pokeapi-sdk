...
beforeEach(function (): void {
    $this->endpoint = ResourceEndpoints::LOCATION_AREA;
    ...
    $this->singleRequestClass = GetSingleLocationArea::class;
    $this->allRequestClass = GetAllLocationAreas::class;
...
describe('Get a single Location Area', function (): void {
    it('sends a request with an id (int) and receives the expected response', function (): void {
        $response = $this->connector->locationArea()->get(1);
    ...
    it('sends a request with a name (string) and receives the expected response', function (): void {
        ...
        $response = $this->connector->locationArea()->get('canalave-city-area');
...
describe('Get all Location Areas', function (): void {
    it('sends a request and receives the expected response', function (): void {
        $response = $this->connector->locationArea()->all();
