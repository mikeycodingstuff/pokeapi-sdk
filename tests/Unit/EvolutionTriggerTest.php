...
beforeEach(function (): void {
    $this->endpoint = ResourceEndpoints::EVOLUTION_TRIGGER;
...
describe('Get a single Evolution Trigger', function (): void {
...
describe('Get all Evolution Triggers', function (): void {
