...
beforeEach(function (): void {
    $this->endpoint = ResourceEndpoints::STAT;
    ...
    $this->singleRequestClass = GetSingleStat::class;
    $this->allRequestClass = GetAllStats::class;
...
describe('Get a single Stat', function (): void {
    ...
    it('sends a request with a name (string) and receives the expected response', function (): void {
        ...
        $response = $this->connector->stat()->get('hp');
...
describe('Get all Stats', function (): void {
    it('sends a request and receives the expected response', function (): void {
        $response = $this->connector->stat()->all();
