...
beforeEach(function (): void {
    $this->endpoint = ResourceEndpoints::MOVE_TARGET;
    ...
    $this->singleRequestClass = GetSingleMoveTarget::class;
    $this->allRequestClass = GetAllMoveTargets::class;
...
describe('Get a single Move Target', function (): void {
    it('sends a request with an id (int) and receives the expected response', function (): void {
        $response = $this->connector->moveTarget()->get(1);
    ...
    it('sends a request with a name (string) and receives the expected response', function (): void {
        ...
        $response = $this->connector->moveTarget()->get('specific-move');
...
describe('Get all Move Targets', function (): void {
    it('sends a request and receives the expected response', function (): void {
        $response = $this->connector->moveTarget()->all();
