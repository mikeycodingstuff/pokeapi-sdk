...
beforeEach(function (): void {
    $this->endpoint = ResourceEndpoints::PAL_PARK_AREA;
    ...
    $this->singleRequestClass = GetSinglePalParkArea::class;
    $this->allRequestClass = GetAllPalParkAreas::class;
...
describe('Get a single Pal Park Area', function (): void {
    it('sends a request with an id (int) and receives the expected response', function (): void {
        $response = $this->connector->palParkArea()->get(1);
    ...
    it('sends a request with a name (string) and receives the expected response', function (): void {
        ...
        $response = $this->connector->palParkArea()->get('forest');
...
describe('Get all Pal Park Areas', function (): void {
    it('sends a request and receives the expected response', function (): void {
        $response = $this->connector->palParkArea()->all();
