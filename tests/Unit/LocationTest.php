...
beforeEach(function (): void {
    $this->endpoint = ResourceEndpoints::LOCATION;
    ...
    $this->singleRequestClass = GetSingleLocation::class;
    $this->allRequestClass = GetAllLocations::class;
...
describe('Get a single Location', function (): void {
    it('sends a request with an id (int) and receives the expected response', function (): void {
        $response = $this->connector->location()->get(1);
    ...
    it('sends a request with a name (string) and receives the expected response', function (): void {
        ...
        $response = $this->connector->location()->get('canalave-city');
...
describe('Get all Locations', function (): void {
    it('sends a request and receives the expected response', function (): void {
        $response = $this->connector->location()->all();
